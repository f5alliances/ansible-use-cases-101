...
The finished Ansible Playbook is provided here for an Answer key.  Click here for [bigip-facts.yml](https://github.com/f5alliances/ansible-use-cases-101/blob/master/1.1-get-facts/bigip-facts.yml).
